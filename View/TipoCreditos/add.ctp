...
<div class="breadcrumb">
       <?php
         ...
         echo $this->Html->link('Alta', 
                                array('controller'=>'TipoCreditos','action'=>'alta'),
				array('title'=>'Inicio','escape' => false));
       ?>
</div><br>
<?php
 echo $this->Form->create('TipoCredito', array('action'=>'add'));
 echo $this->Form->input('TipoCredito.id',array('type'=>'hidden'));
?>
...
<div class="row-fluid">
	<div class="span8">
		...
		<?php
			echo $this->Croogo->adminTab(__d('croogo', 'TipoCredito'), '#menu-basic');
		...
		<div class="tab-content">
		 <div id="menu-basic" class="tab-pane"><br>
          <?php
                 ...
                 echo $this->Form->input('TipoCredito.tipo',
				            array('label' => false,
						  'type'=>'text',
						  'style'=>'width:90%;',
						  'maxlength'=>'255',

...
class XTCPDF  extends TCPDF { 
 ...
 function Encabezado($url,$fecha,$saldo,$fechamovimientos) {
  ...
  $this->Cell(0.1); $this->Cell(25,5,'Cuenta',1,0,'R',1); 
  $this->SetFillColor(255,255,255);  $this->SetTextColor(0);
  $this->Cell(0.1); $this->Cell(77,5,$url['c'],1,0,'L');  $this->Ln(5);
  $this->SetFillColor(229,229,229);  $this->SetTextColor(68);
 ...
 $pdf->Encabezado($dataurl,$fecha,$saldo,$fmovi);

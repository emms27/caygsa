...
<div class="breadcrumb">
       <?php
         ...
         echo $this->Html->link('Expediente', 
                                array('controller'=>'Expediente','action'=>'index'),
...
<table border="0">
 <tr>
  ...
  <td width="28%"><h1>Reporte por Juzgado</h1></td>
  <td width="68%">
   <?php echo $this->Form->create('Expediente',array('action'=>'consulta_juzgado')); ?>
   <table border="0">
    <tr valign="bottom">
     <td>de:</td>
     <td >
 ...
 <tr>
  <td colspan="3" class="arial11gris" align="left" style="padding-top:10px; padding-bottom:17px;">
   El reporte de <i>Juzgados</i> es una consulta según el juzgado y el rango de fechas (Fichas- fecha de deposito, Pagos - fecha de registro) dadas por el usuario; para mostrar una línea temporal de todos los movimientos en el Sistema .
  </td>
 </tr>
</table>

 ...
 */
    ...
    $tableHeaders = $this->Html->tableHeaders(array('',
		    $this->Paginator->sort('Ocupacione.ocupacion', 'Ocupación'),
   		    $this->Paginator->sort('Ocupacione.fecha_registro', 'Fecha Registro'),
  		    $this->Paginator->sort('Ocupacione.fecha_update', 'Última Actualización'),
  		    $this->Paginator->sort('Ocupacione.ver', 'Status'),
		    'Acci&oacute;n'),
...
<div id="breadcrumb">
        <?php
              ...
              $this->Html->addCrumb('Catálogos',  '/Ocupaciones'); 
              $this->Html->addCrumb('Ocupación',  '/Ocupaciones'); 
              $this->Html->addCrumb('Consulta' ,  '/Ocupaciones' , array('class' => 'breadcrumblast')); 
 ...
 <div class="row-fluid">
  <div class="span12 actions">
   <ul class="nav-buttons">
    <li>
        <?php
         echo $this->Html->link('New Ocupación', 
                                array('controller'=>'Ocupaciones','action'=>'add'),
 ...
 <div class="row-fluid">
  <div class="span12">
   <table class="table table-striped">
    ...
    <?php $p=1; foreach ($ocupaciones as $cliente):  ?>
    <tr>
     <td><?php echo $p; ?></td>
     <td><?php echo $cliente['Ocupacione']['ocupacion']; ?> </td>
     <td><?php echo $cliente['Ocupacione']['fecha_registro']; ?></td>
     <td><?php echo $cliente['Ocupacione']['fecha_update']; ?></td>
     <td>
      <?php
       if ($cliente['Ocupacione']['ver']==0) $sclass="icon-remove red ajax-toggle";
       else $sclass="icon-ok green ajax-toggle";

         echo $this->Html->link('<i class="'.$sclass.'"></i>',
                                array('controller'=>'Ocupaciones','action'=>'status',$cliente['Ocupacione']['id']),
  ...
  <?php
         echo $this->Html->link('<i class="icon-search icon-large"></i>',
                                array('controller'=>'Clientes','action'=>'edit',$cliente['Ocupacione']['id']),
				array('title'=>'Ver este elemento',
				      'escape' => false,
				      'class'=>'view',
				      'data-title'=>'Ver este elemento',
	 ...
	 echo $this->Form->postLink(_(''),
          array('action' => 'delete',$cliente['Ocupacione']['id']),
	  array('class'=>'icon-trash icon-large',
		'title'=>'Eliminar este elemento',
	        'data-title'=>"Eliminar este elemento",
	        'rel'=>"tooltip"),
		 __('¿Realmente desea hacer copiar de la orden %s?',$cliente['Ocupacione']['id'])
         );		 ?>
     </div>
    </td>
    <?php $p++; endforeach; ?>

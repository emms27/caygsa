...
<?php
 echo $this->Form->create('Ocupacione', array('action'=>'add'));
 echo $this->Form->input('Ocupacione.id',array('type'=>'hidden'));
?>
...
<div class="row-fluid">
	<div class="span8">
		...
		<?php
			echo $this->Croogo->adminTab(__d('croogo', 'Ocupación'), '#menu-basic');
		...
		<div class="tab-content">
		 <div id="menu-basic" class="tab-pane"><br>
          <?php
                 echo $this->Form->input('Ocupacione.ocupacion',
				            array('label' => false,
						  'type'=>'text',
						  'style'=>'width:90%;',
						  'maxlength'=>'50',

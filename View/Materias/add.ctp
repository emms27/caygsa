...
<div class="breadcrumb">
       <?php
         ...
         echo $this->Html->link('Partes', 
                                array('controller'=>'Materia','action'=>'index'),
				array('title'=>'Inicio','escape' => false));
         echo '<span class="divider">/</span>';
         echo $this->Html->link('Alta', 
                                array('controller'=>'Materia','action'=>'alta'),
				array('title'=>'Inicio','escape' => false));
       ?>
</div><br>
<?php
 echo $this->Form->create('Materia', array('action'=>'add'));
...
<div class="row-fluid">
	<div class="span8">
		...
		<?php
			echo $this->Croogo->adminTab(__d('croogo', 'Materia'), '#menu-basic');
		...
		<div class="tab-content">
		 <div id="menu-basic" class="tab-pane"><br>
          <?php
                 echo $this->Form->input('Materia.descripcion',
				            array('label' => false,
						  'type'=>'text',
						  'style'=>'width:90%;',
						  'maxlength'=>'50',

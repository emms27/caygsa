   ...
   <div class="square3_Externo">
    ...
    <div class="square3_Interno">                                         
     <table border="0">
	  ...
	  $toficio=array('F'=>'Femenino','M'=>'Masculino');  
	  $aoficio=array('legend'=>false,'disabled'=>false);//,'checked'=> ($foo == "Aclarativos") ? FALSE : TRUE,);
          echo '<div id="csexo">';
   	  echo $this->Form->radio('Cliente.sexo', $toficio,$aoficio);
	  echo $this->Form->error('Cliente.sexo');  
          echo '</div>';
         ?>
       </td>
      </tr>

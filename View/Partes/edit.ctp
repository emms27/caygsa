...
<?php
 echo $this->Form->create('Parte', array('action'=>'edit'));
   ...
   <div class="square3_Externo">
      ...
      <tr>
       <td>
        <table border="0" width="100%">
         <tr>
          <td>
    <?php  if ($this->request->data['Parte']['sexo']=='F'){ ?>
      <div id="csexo">
        <input type="radio" id="radio1" name="data[Parte][sexo]" value="F" required="required" checked />
        <label for="radio1">Femenino</label>
        <input type="radio" id="radio2" name="data[Parte][sexo]" value="M" required="required" />
	<label for="radio2">Masculino</label>
     </div>
    <?php }else{ ?>
      <div id="csexo">
        <input type="radio" id="radio1" name="data[Parte][sexo]" value="F" required="required" />
        <label for="radio1">Femenino</label>
        <input type="radio" id="radio2" name="data[Parte][sexo]" value="M" required="required" checked />
	<label for="radio2">Masculino</label>
     </div>
     ...
     <?php }  echo $this->Form->error('Parte.sexo'); ?>
       ...
       <td>
    <?php  if ($this->request->data['Parte']['tipo']=='Autor'){ ?>
      <div id="ctipo">
        <input type="radio" id="ctipo1" name="data[Parte][tipo]" value="Autor" required="required" checked/>
        <label for="ctipo1">Autor</label>
    ...
    <?php }else{ ?>
      <div id="ctipo">
        ...
        <label for="ctipo1">Autor</label>
        <input type="radio" id="ctipo2" name="data[Parte][tipo]" value="Demandado" required="required" checked/>
	<label for="ctipo2">Demandado</label>
     </div>
